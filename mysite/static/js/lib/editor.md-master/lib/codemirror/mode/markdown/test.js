...
(function() {
  ...
  FT("formatting_atxHeader",
     "[headers&headers-1&formatting&formatting-headers&formatting-headers-1 #][headers&headers-1  foo # bar ][headers&headers-1&formatting&formatting-headers&formatting-headers-1 #]");

  FT("formatting_setextHeader",
     "foo",
     "[headers&headers-1&formatting&formatting-headers&formatting-headers-1 =]");
  ...
  MT("atxH1",
     "[headers&headers-1 # foo]");

  MT("atxH2",
     "[headers&headers-2 ## foo]");

  MT("atxH3",
     "[headers&headers-3 ### foo]");

  MT("atxH4",
     "[headers&headers-4 #### foo]");

  MT("atxH5",
     "[headers&headers-5 ##### foo]");

  MT("atxH6",
     "[headers&headers-6 ###### foo]");
  ...
  MT("atxH1inline",
     "[headers&headers-1 # foo ][headers&headers-1&em *bar*]");

  // Setext headers - H1, H2
  // Per documentation, "Any number of underlining =’s or -’s will work."
  // http://daringfireball.net/projects/markdown/syntax#header
  // Ideally, the text would be marked as `headers` as well, but this is
