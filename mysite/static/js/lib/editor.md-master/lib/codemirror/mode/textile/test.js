...
(function() {
  ...
  MT('h1',
      '[headers&headers-1 h1. foo]');

  MT('h2',
      '[headers&headers-2 h2. foo]');

  MT('h3',
      '[headers&headers-3 h3. foo]');

  MT('h4',
      '[headers&headers-4 h4. foo]');

  MT('h5',
      '[headers&headers-5 h5. foo]');

  MT('h6',
      '[headers&headers-6 h6. foo]');

  MT('h7Bogus',
      'h7. foo');

  MT('multipleHeaders',
      '[headers&headers-1 h1. Heading 1]',
      '',
      'Some text.',
      '',
      '[headers&headers-2 h2. Heading 2]',
      '',
      'More text.');

  MT('h1inline',
      '[headers&headers-1 h1. foo ][headers&headers-1&em _bar_][headers&headers-1  baz]');
  ...
  MT('bq..ThenH1',
      ...
      '',
      '[bracket More quote.]',
      '[headers&headers-1 h1. Header Text]');
