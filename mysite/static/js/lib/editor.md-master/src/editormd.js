;(function(factory) {
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.heading = function(text, level, raw) {
            ...
            headingHTML    += "<span class=\"headers-link octicon octicon-link\"></span>";
    ...
    editormd.createDialog = function(options) {
        ...
        if (options.title !== "")
        {
            html += "<div class=\"" + classPrefix + "dialog-headers\"" + ( (options.drag) ? " style=\"cursor: move;\"" : "" ) + ">";
        ...
        {                        
            var posX, posY;
            var dialogHeader = dialog.children("." + classPrefix + "dialog-headers");
